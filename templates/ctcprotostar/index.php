...
elseif ($bLeftModules && !$this->countModules('position-8'))
{
	$span = "span9";
}
elseif (!$bLeftModules && $this->countModules('position-8'))
...
?>">
	...
	<div class="body">
		<div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : ''); ?>">
			<!-- Header -->
			<header class="header hidden-tablet hidden-phone" role="banner">
			...
			<div class="row-fluid">
				<?php if ($bLeftModules) : ?>
					...
					<?php if ($this->countModules('publicmenu')) : ?>
       						<!-- Add custompostion -->
						<div class="sidebar-nav">
        						<jdoc:include type="modules" name="publicmenu" style="well" />
						</div>
        					<!-- End Custom Postion -->
					<?php endif; ?>
